  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved option as @option" do
        ...
        post :create, {:option => { "use_news" => "invalid value" }}, valid_session
        assigns(:option).should be_a_new(Option)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested option" do
        ...
        Option.any_instance.should_receive(:update_attributes).with({ "use_news" => "false" })
        put :update, {:id => option.to_param, :option => { "use_news" => "false" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the option as @option" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Option.any_instance.stub(:save).and_return(false)
        put :update, {:id => option.to_param, :option => { "use_news" => "invalid value" }}, valid_session
        assigns(:option).should eq(option)
      end
