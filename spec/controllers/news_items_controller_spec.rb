  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved news_item as @news_item" do
        ...
        post :create, {:news_item => { "title" => "invalid value" }}, valid_session
        assigns(:news_item).should be_a_new(NewsItem)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested news_item" do
        ...
        NewsItem.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
        put :update, {:id => news_item.to_param, :news_item => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the news_item as @news_item" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        NewsItem.any_instance.stub(:save).and_return(false)
        put :update, {:id => news_item.to_param, :news_item => { "title" => "invalid value" }}, valid_session
        assigns(:news_item).should eq(news_item)
      end
