  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved sermon as @sermon" do
        ...
        post :create, {:sermon => { "date" => "invalid value" }}, valid_session
        assigns(:sermon).should be_a_new(Sermon)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested sermon" do
        ...
        Sermon.any_instance.should_receive(:update_attributes).with({ "date" => "2013-02-17" })
        put :update, {:id => sermon.to_param, :sermon => { "date" => "2013-02-17" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the sermon as @sermon" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Sermon.any_instance.stub(:save).and_return(false)
        put :update, {:id => sermon.to_param, :sermon => { "date" => "invalid value" }}, valid_session
        assigns(:sermon).should eq(sermon)
      end
